...
const MedicationReminderSchema = new mongoose_1.Schema({
    patientId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Patient', required: true },
    prescriptionId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Prescription', required: true },
...
exports.MedicationReminder = mongoose_1.default.model('MedicationReminder', MedicationReminderSchema);
